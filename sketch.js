...
if(box.isTouching(surface2)){
     box.shapeColor="blue"; box.velocityX=0; box.velocityY=0;
     }
     if(box.isTouching(surface1)){
        box.shapeColor="blue"; box.velocityX=0; box.velocityY=0;
        }  
        ...
        if(box.isTouching(surface3)){
            box.shapeColor="red"; box.velocityX=0; box.velocityY=-0;
            } 
            if(box.isTouching(surface4)){
                box.shapeColor="orange"; box.velocityX=0; box.velocityY=0;
